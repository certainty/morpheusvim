return {
  {
    ...
    dependencies = {
      ...
      'zbirenbaum/copilot.lua',
      {
        ...
        enbled = Morpheus.is_enabled { 'ai', 'codecompanion', 'mcphub' },
      ...
      },
      {
        'Davidyz/VectorCode',
        version = '*',
        enabled = Morpheus.is_enabled { 'ai', 'codecompanion', 'vectorcode' },
    ...
    opts = function()
      local extensions = {}
      if Morpheus.is_enabled { 'ai', 'codecompanion', 'mcphub' } then
        extensions.mcphub = {
      ...
      if Morpheus.is_enabled { 'ai', 'codecompanion', 'vectorcode' } then
