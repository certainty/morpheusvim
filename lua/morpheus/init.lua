...
M.capabilities = {
  ...
  writing = { markdown = { images = false, preview = false, lsp = true } },
...
function M.setup()
  require('lazy').setup({
    { import = 'morpheus.core.base' },
    { import = 'morpheus.core.extended' },
    { import = 'morpheus.extras.ui' },
    { import = 'morpheus.extras.lang' },
    { import = 'morpheus.extras.ai' },
    { import = 'morpheus.extras.tools' },
    { import = 'morpheus.extras.writing' },
  }, {
    ui = { border = 'rounded' },
  })
end
